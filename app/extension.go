...
func (app *TerraApp) BeginBlockHook(rabbit *amqp.Channel, blockerFunctions []func(*TerraApp, *amqp.Channel, sdk.Context, types.RequestBeginBlock)) sdk.BeginBlocker {
...
func BalancesBlocker(app *TerraApp, rabbit *amqp.Channel, ctx sdk.Context, req types.RequestBeginBlock) {
...
func DelegationsBlocker(app *TerraApp, rabbit *amqp.Channel, ctx sdk.Context, req types.RequestBeginBlock) {
...
func TxsBlockerForBlock(block tm.Block) func(*TerraApp, *amqp.Channel, sdk.Context, types.RequestBeginBlock) {

	return func(app *TerraApp, rabbit *amqp.Channel, ctx sdk.Context, req types.RequestBeginBlock) {
