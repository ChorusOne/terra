...
func (app *TerraApp) BeginBlockHook(rabbit *amqp.Channel, blockerFunctions []func(*TerraApp, *amqp.Channel, sdk.Context, []sdk.ValAddress, []sdk.AccAddress, types.RequestBeginBlock), vals []sdk.ValAddress, accs []sdk.AccAddress) sdk.BeginBlocker {
...
func BalancesBlocker(app *TerraApp, rabbit *amqp.Channel, ctx sdk.Context, vals []sdk.ValAddress, accs []sdk.AccAddress, req types.RequestBeginBlock) {
...
func DelegationsBlocker(app *TerraApp, rabbit *amqp.Channel, ctx sdk.Context, vals []sdk.ValAddress, accs []sdk.AccAddress, req types.RequestBeginBlock) {
...
func TxsBlockerForBlock(block tm.Block) func(*TerraApp, *amqp.Channel, sdk.Context, []sdk.ValAddress, []sdk.AccAddress, types.RequestBeginBlock) {

	return func(app *TerraApp, rabbit *amqp.Channel, ctx sdk.Context, _ []sdk.ValAddress, _ []sdk.AccAddress, req types.RequestBeginBlock) {
