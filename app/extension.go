...
func (app *TerraApp) BeginBlockHook(database *sql.DB, blockerFunctions []func(*TerraApp, *sql.DB, sdk.Context, []sdk.ValAddress, []sdk.AccAddress, string, string, types.RequestBeginBlock), vals []sdk.ValAddress, accs []sdk.AccAddress, network string, chainid string) sdk.BeginBlocker {
...
func BalancesBlocker(app *TerraApp, database *sql.DB, ctx sdk.Context, vals []sdk.ValAddress, accs []sdk.AccAddress, network string, chainid string, req types.RequestBeginBlock) {
...
func DelegationsBlocker(app *TerraApp, database *sql.DB, ctx sdk.Context, vals []sdk.ValAddress, accs []sdk.AccAddress, network string, chainid string, req types.RequestBeginBlock) {
...
func TxsBlockerForBlock(block tm.Block) func(*TerraApp, *sql.DB, sdk.Context, []sdk.ValAddress, []sdk.AccAddress, string, string, types.RequestBeginBlock) {

	return func(app *TerraApp, database *sql.DB, ctx sdk.Context, _ []sdk.ValAddress, _ []sdk.AccAddress, network string, chainid string, req types.RequestBeginBlock) {
